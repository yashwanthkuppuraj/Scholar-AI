...
genai.configure(api_key="AIzaSyAngy9tRm5UIRH8kPKs2Mw6CG-a9Aagk40")
...
def video_call():
    ...
    return render_template('video_call.html', role=role)
...
def generate_content2():
    ...
    prompt = f"give me {title} youtube video link which is best compared to the others with roadmap, summary, and quiz (5 questions) in json format dont give any explanations  "
